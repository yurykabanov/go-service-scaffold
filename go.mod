module github.com/yurykabanov/service-scaffold
...
require (
	...
	github.com/yurykabanov/echo-logrus v0.0.0-20200211144814-64eebe851cd1
	github.com/yurykabanov/fxm v0.0.0-20200212111512-c671cac79679
